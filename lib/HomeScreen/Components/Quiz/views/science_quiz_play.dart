import 'package:E_Companion/HomeScreen/Components/Quiz/data/sciencedata.dart';
...
class SQuizPlay extends StatefulWidget {
  @override
  _QuizPlayState createState() => _QuizPlayState();
}

class _QuizPlayState extends State<SQuizPlay>
    with SingleTickerProviderStateMixin {
  List<SQuestionModel> _questions = new List<SQuestionModel>();
